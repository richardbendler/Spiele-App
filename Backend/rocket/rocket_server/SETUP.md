...
## Rocket.toml
The `Rocket.toml` acts as the configuration file for the server. Copy from `Spiele-App/Backend/rocket/Rocket.toml` to server (`/home/trinkspielapp/rocket_server`)
